...
<div class="bw-inline-tooltip-container bw-inline-tooltip-hidden">
  ...
  <div class="bw-inline-tooltip-bottom-row">
    <svg class="bw-inline-tooltip-logo-svg" enable-background="new 0 0 14 14" height="14" viewBox="0 0 512 512" width="14" fill="#fff" xmlns="http://www.w3.org/2000/svg"><g><path d="m435.411 113.825v-76.589l76.589 76.589zm-29.967-76.589v139.177l-69.589-69.589zm-167.647 13.909 161.441 161.44-118.899 118.899-280.339-280.339zm-100.738 254.476 37.519-37.519 84.572 84.571-122.091 122.091z"/></g></svg>
    <div>Content by BrandWeaver AI. Info quality may vary.</div>
  </div>
</div>
`.trim();
